...
pub fn normalise_charset(character_set: &str) -> String {
...
mod tests {
    ...
    #[test]
    fn test_normalise_charset() {
        assert_eq!(normalise_charset("dummy"), "DUMMY");
        assert_eq!(normalise_charset("UTF8"), "UTF-8");
        assert_eq!(normalise_charset("utf-8"), "UTF-8");
        assert_eq!(normalise_charset("MACINTOSH"), "CP1252");
        assert_eq!(normalise_charset("WINDOWS-1255"), "ISO-8859-8");
    }
}